...
class CityNewsContainer extends Component {
    ...
    return (
      <React.Fragment>
        <div onWheel = {this.handleWheel}>
          <PageIntro title="CITY NEWS" description={this.props.data.blurb} img_src={this.props.data.img}/>
...
export default CityNewsContainer;
